...
info = '👤¦ بواسطة » ['..result.first_name_..'](t.me/'..(result.username_ or 'tshaketeam')..')\n🎫¦ الايدي » {'..result.id_..'}\n'..text
...
texts = '👤¦ بواسطة » ['..result.title_..'](t.me/'..(result.username_ or 'tshaketeam')..')\n🎫¦ الايدي » {'..result.id_..'}\n☑️¦ تم حظره ✓'
...
send(msg.chat_id_, msg.id_, 1, '👤¦  لا تستطيع حظر او طرد (مدراء، ادمنية،مميزين)البوت   ✓', 1, 'md')
else
