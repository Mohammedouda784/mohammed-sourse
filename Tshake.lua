...
{
{text = ''..(channel_ts or "TshAkE TEAM")..'', url=''..(channel_user_ts or 't.me/TTYYii')..''},
},
}
...
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apmd[2] or 'TTYYii')..')\n\n☑┇تم رفعه مطور'
else
texts = '📛┇لايوجد'
end
...
send(msg.chat_id_, msg.id_, 1, '📛┇لا تستطيع حظرعام \n⚠️┇الاداريين او المميزين في البوت', 1, 'md')
else
...
local hash =  'tshake:'..bot_id..'gbanned:'
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apbll[2] or 'TTYYii')..')\n🎫¦ الايدي » {'..result.id_..'}\n🚫┇تم حظره من المجموعات البوت'
...
local hash =  'tshake:'..bot_id..'gbanned:'
if result.id_ then
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apid[2] or 'TTYYii')..')\n��┇تم الغاء حظره من المجموعات البوت'
...
if text == "تفعيل"  then
function TSby(extra,result,success)
info = '💬┇بواسطه ~⪼ ['..result.first_name_..'](t.me/'..(result.username_ or 'TTYYii')..')\n'
if database:get( 'tshake:'..bot_id.."charge:"..msg.chat_id_) then
function thsake_info(k1,k2)
...
send(msg.chat_id_, msg.id_, 1, "🛠 ● لايمكنك فتح الوسائط حاليا ⛔️ ", 1, 'md')
return false end
local tsX_o = database:get("lock_edit:tshake"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑️¦ بالفعل تم قفل التعديل✓")
else
tsX000("lock",msg,"☑️¦ تم قفل التعديل✓")
database:set("lock_edit:tshake"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل تعديل الميديا") and (is_creator(msg) or is_creatorbasic(msg)) then
if not is_creator(msg) and database:get("Tshake:lock:all"..bot_id..msg.chat_id_) then 
send(msg.chat_id_, msg.id_, 1, "🛠 ● لايمكنك فتح الوسائط حاليا ⛔️ ", 1, 'md')
return false end
local tsX_o = database:get("lock_edit1:tshake"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑️¦ بالفعل تم قفل التعديل✓")
else
tsX000("lock",msg,"☑️¦ تم قفل التعديل✓")
database:set("lock_edit1:tshake"..msg.chat_id_..bot_id,"ok")
end
end
...
if (text == "قفل الميديا") and (is_creator(msg) or is_creatorbasic(msg)) then
if not is_creator(msg) and database:get("Tshake:lock:all"..bot_id..msg.chat_id_) then 
send(msg.chat_id_, msg.id_, 1, "🛠 ● لايمكنك فتح الوسائط حاليا ⛔️ ", 1, 'md')
return false end
local tsX_o = database:get("lock_media:tshake"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑️¦ بالفعل تم قفل الميديا ✓")
else
tsX000("lock",msg,"☑️¦ تم قفل الميديا ✓")
...
if not is_creator(msg) and database:get("Tshake:lock:all"..bot_id..msg.chat_id_) then 
send(msg.chat_id_, msg.id_, 1, "🛠 ● لايمكنك قفل الدخول حاليا ⛔️ ", 1, 'md')
return false end
local tsX_o = database:get("lock_join:tshake"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑️ ● بالفعل تم قفل الدخول للمجموعه 📛")
else
tsX000("lock",msg,"☑️ ● تم قفل الدخول للمجموعه ✓")
...
if (text == "فتح تعديل الميديا") and (is_creator(msg) or is_creatorbasic(msg)) then
if not is_creator(msg) and database:get("Tshake:lock:all"..bot_id..msg.chat_id_) then 
send(msg.chat_id_, msg.id_, 1, "🛠 ● لايمكنك فتح الوسائط حاليا ⛔️ ", 1, 'md')
return false end
local tsX_o = database:get("lock_edit1:tshake"..msg.chat_id_..bot_id)
...
tsX000("lock",msg,"☑️¦ تم فتح التعديل✓")
database:del("lock_edit1:tshake"..msg.chat_id_..bot_id,"ok")
end
end
...
if (text == "فتح الميديا") and (is_creator(msg) or is_creatorbasic(msg)) then
if not is_creator(msg) and database:get("Tshake:lock:all"..bot_id..msg.chat_id_) then 
send(msg.chat_id_, msg.id_, 1, "🛠 ● لايمكنك فتح الوسائط حاليا ⛔️ ", 1, 'md')
return false end
local tsX_o = database:get("lock_media:tshake"..msg.chat_id_..bot_id)
...
database:sadd('tshake:'..bot_id..'banned:'..msg.chat_id_, msg.sender_user_id_)
end
end
...
tsX000("prore",msg,'👑¦ تم رفعه منشئ اساسي في البوت ✓')
end
getMessage(msg.chat_id_, msg.reply_to_message_id_,promote_by_reply)
end
...
tsX000(apmd[2],msg,"👑¦ تم رفعه منشئ اساسي في البوت ✓")
end
...
tsX000("prore",msg,"👑¦ بالفعل تم رفعه منشئ في المجموعة ✓")
else
database:sadd(hash, result.sender_user_id_)
tsX000("prore",msg,"👑¦ تم رفعه منشئ في المجموعة ✓")
end
end
...
texts = '👤¦ العضو ['..result.title_..'](t.me/'..(apow[2] or 'TTYYii')..')\n👑¦ تم رفعه منشئ في المجموعة ✓'
else
texts = '📛┇لايوجد'
end
send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
...
tsX000(apow[2],msg,"👑¦ تم رفعه منشئ في المجموعة ✓")
end
...
tsX000("prore",msg,"☑️¦ بالفعل تم تنزيله من قائمة المنشئيين ✓")
else
database:srem(hash, result.sender_user_id_)
tsX000("prore",msg,"☑️¦ تم تنزيله من قائمة المنشئيين ✓	")
end
end
...
if result.id_ then
database:srem(hash, result.id_)
texts = '👤¦ العضو ['..result.title_..'](t.me/'..(apow[2] or 'TTYYii')..')\n☑️¦ تم تنزيله من قائمة المنشئيين ✓'
else
texts = '📛┇لايوجد'
end
send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
...
text = text.."★_l  »(@"..username..")\n"
else
text = text.."★_l  »</b>~⪼(<code>"..v.."</code>)\n"
end
if #text > 7000 then
...
texts = '💁🏻‍♂️※ العضو ✓['..result.title_..'](t.me/'..(apmd[2] or 'TTYYii')..')\n※ تم رفعة منشئ   في الكروب ✓ 👨🏻‍🚒'
else
texts = '📛┇لايوجد'
end
send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
...
tsX000(apmd[2],msg,"🛠¦ تم رفعه ادمن في البوت ✓")
end
...
local hash =  'tshake:'..bot_id..'mods:'..msg.chat_id_
if not database:sismember(hash, result.sender_user_id_) then
tsX000("prore",msg,"☑️¦ بالفعل تم تنزيله من ادمنيه البوت ✓")
else
database:srem(hash, result.sender_user_id_)
tsX000("prore",msg,"☑️¦ تم تنزيله من ادمنيه البوت ✓")
end
end
getMessage(msg.chat_id_, msg.reply_to_message_id_,demote_by_reply)
end
...
if database:sismember(hash, result.sender_user_id_) then
tsX000("prore",msg,"⭐️¦ بالفعل تم رفعه مميز في البوت ✓") 
else
database:sadd(hash, result.sender_user_id_)
tsX000("prore",msg,"⭐️¦ تم رفعه مميز في البوت ✓")
end
end
getMessage(msg.chat_id_, msg.reply_to_message_id_,promote_by_reply)
end
...
local text = text:gsub('رفع مميز','رفع عضو مميز')
if text:match("^رفع عضو مميز (%d+)$") and (is_mod(msg) or is_creatorbasic(msg)) then
if not is_creator(msg) and database:get("Tshake:lock:promote"..bot_id..msg.chat_id_) then 
send(msg.chat_id_, msg.id_, 1, "🛠 ● عذرا خاصية الرفع معطله ⛔️ ", 1, 'md')
return false end
if not  is_creatorbasic(msg) and database:sismember('tshake:'..bot_id..'mnaa:'..msg.chat_id_, msg.sender_user_id_)   then
...
if (text:match("^تنزيل عضو مميز$") or text:match("^تنزيل مميز$")) and (is_mod(msg) or is_creatorbasic(msg)) and msg.reply_to_message_id_ then
function demote_by_reply(extra, result, success)
local hash =  'tshake:'..bot_id..'vipgp:'..msg.chat_id_
if not database:sismember(hash, result.sender_user_id_) then
tsX000("prore",msg,"☑️¦ تم تنزيله من قائمه المميزين ✓")  
else
database:srem(hash, result.sender_user_id_)
tsX000("prore",msg,"☑️¦ تم تنزيله من قائمه المميزين ✓")
end
...
if text:match("^تنزيل عضو مميز @(.*)$") and (is_mod(msg) or is_creatorbasic(msg)) then
local hash =  'tshake:'..bot_id..'vipgp:'..msg.chat_id_
local apmd = {string.match(text, "^(تنزيل عضو مميز) @(.*)$")}
function demote_by_username(extra, result, success)
if result.id_ then
database:srem(hash, result.id_)
texts = '👤¦  العضو ✓['..result.title_..'](t.me/'..(apmd[2] or 'TTYYii')..')\n☑️¦ تم تنزيله من قائمه المميزين ✓'
else
texts = '📛┇لايوجد'
end
send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
...
local text = text:gsub('تنزيل مميز','تنزيل عضو مميز')
if text:match("^تنزيل عضو مميز (%d+)$") and (is_mod(msg) or is_creatorbasic(msg)) then
local hash =  'tshake:'..bot_id..'vipgp:'..msg.chat_id_
local apmd = {string.match(text, "^(تنزيل عضو مميز) (%d+)$")}
database:srem(hash, apmd[2])
tsX000(apmd[2],msg,"☑️¦ تم تنزيله من قائمه المميزين ✓")
end  
...
if database:sismember(hash, result.sender_user_id_) then
tsX000("prore",msg,"☑️¦ بالفعل تم حظره ✓")
chat_kick(result.chat_id_, result.sender_user_id_)
else
database:sadd(hash, result.sender_user_id_)
tsX000("prore",msg,"☑️¦ تم حظره ✓")
chat_kick(result.chat_id_, result.sender_user_id_)
end
end
end
...
texts = '👤¦  العضو ✓['..result.title_..'](t.me/'..(apba[2] or 'TTYYii')..')\n☑┇تم تحريره من القيود'
end
send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
end
...
----------------------------------------------unban--------------------------------------------
if text:match("^الغاء الحظر$") and (is_mod(msg) or is_creatorbasic(msg)) and msg.reply_to_message_id_ then
function unban_by_reply(extra, result, success)
local hash =  'tshake:'..bot_id..'banned:'..msg.chat_id_
if not database:sismember(hash, result.sender_user_id_) then
tsX000("prore",msg,"☑️¦ بالفعل تم الغاء الحظر من البوت")
else
database:srem(hash, result.sender_user_id_)
tsX000("prore",msg,"☑¦تم الغاء الحظر من البوت")
end
end
...
if text:match("^الغاء الحظر (%d+)$") and (is_mod(msg) or is_creatorbasic(msg)) then
local apba = {string.match(text, "^(الغاء الحظر) (%d+)$")}
database:srem('tshake:'..bot_id..'banned:'..msg.chat_id_, apba[2])
tsX000(apba[2],msg,"☑¦تم الغاء الحظر من البوت") 
end
...
if ck_mod(result.sender_user_id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, 1, '👤¦  لا تستطيع مسح رسائل (مدراء، ادمنية،مميزين)البوت   ✓', 1, 'md')
else
...
if text:match("^الغاء الكتم العام$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) and msg.reply_to_message_id_ then
...
if text:match("^الغاء الكتم العام @(.*)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
local apid = {string.match(text, "^(الغاء الكتم العام) @(.*)$")}
...
if text:match("^الغاء الكتم العام (%d+)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
local apbll = {string.match(text, "^(الغاء الكتم العام) (%d+)$")}
local hash =  'tshake:'..bot_id..'gmuted:'
database:srem(hash, apbll[2])
...
tsX000(apsi[2],msg,"🔕¦ تم كتمه ✓")
end
end
if text:match("^الغاء الكتم$") and (is_mod(msg) or is_creatorbasic(msg)) and msg.reply_to_message_id_ then
function unmute_by_reply(extra, result, success)
local hash =  'tshake:'..bot_id..'muted:'..msg.chat_id_
if not database:sismember(hash, result.sender_user_id_) then
tsX000("prore",msg,"🔔¦ بالفعل تم الغاء كتمه ✓")
else
database:srem(hash, result.sender_user_id_)
tsX000("prore",msg,"🔔¦ تم الغاء كتمه ✓")
end
end
getMessage(msg.chat_id_, msg.reply_to_message_id_,unmute_by_reply)
end
if text:match("^الغاء الكتم @(.*)$") and (is_mod(msg) or is_creatorbasic(msg)) then
local apsi = {string.match(text, "^(الغاء الكتم) @(.*)$")}
...
if text:match("^الغاء الكتم (%d+)$") and (is_mod(msg) or is_creatorbasic(msg)) then
local apsi = {string.match(text, "^(الغاء الكتم) (%d+)$")}
database:srem('tshake:'..bot_id..'muted:'..msg.chat_id_, apsi[2])
tsX000(apsi[2],msg,"🔔¦ تم الغاء كتمه ✓")
end
...
tsX000("prore",msg,"🚫¦ تم الطرد من المجموعه")
chat_kick(result.chat_id_, result.sender_user_id_)
end
end
...
if database:sismember(hash, result.sender_user_id_) then
tsX000("prore",msg,"🛠¦ بالفعل تم رفعه مدير في البوت ✓")
else
database:sadd(hash, result.sender_user_id_)
tsX000("prore",msg,"🛠¦ تم رفعه مدير في البوت ✓")
end
end
...
tsX000(apow[2],msg,"🛠¦ تم رفعه مدير في البوت ✓")
end  
...
local hash =  'tshake:'..bot_id..'owners:'..msg.chat_id_
if not database:sismember(hash, result.sender_user_id_) then
tsX000("prore",msg,"☑️¦ بالفعل تم تنزيله من مدراء البوت ✓")
else
database:srem(hash, result.sender_user_id_)
...
database:srem(hash, apow[2])
tsX000(apow[2],msg,"☑️¦ تم تنزيله من مدراء  البوت ✓👨🏻‍⚖️")
end
...
if text:match("^وضع الترحيب (.*)$") and (is_mod(msg) or is_creatorbasic(msg)) then
local welcome = {string.match(text, "^(وضع الترحيب) (.*)$")}
send(msg.chat_id_, msg.id_, 1, '💭¦ تم وضع ترحيب ✓\n📜¦»('..welcome[2]..')', 1, 'md')
database:set('tshake:'..bot_id..'welcome:'..msg.chat_id_,welcome[2])
end
if text:match("^مسح الترحيب$") and (is_mod(msg) or is_creatorbasic(msg)) then
...
send(msg.chat_id_, msg.id_, 1, "☑️┇تم حذفها من قائمه المنع\n🚫┇{"..rws[2].."}", 1, 'md')
end  
...
if user_info and user_info.username then
local username = user_info.username
text = text..""..n.."| (@"..username..")\n"
else
text = text..""..n.."| "..v.user_id_.."</code>)\n"
end
end
if #text > 7000 then
send(msg.chat_id_, msg.id_, 1, text, 1, 'html')
...
send(msg.chat_id_, msg.id_, 1, '☑️ ● تم مسح الاعضاء المحظورين ✓ ', 1, 'md')
end
...
send(msg.chat_id_, msg.id_, 1, '☑️ ● تم مسح  قائمة المدراء ✓', 1, 'md')
end
...
send(msg.chat_id_, msg.id_, 1, '☑️ ● تم مسح قائمة المكتومين ✓', 1, 'md')
end
end
...
send(msg.chat_id_, msg.id_, 1, '☑️ ● تم تعطيل (طرد + حظر) الاعضاء ✓', 1, 'md')
end
...
send(msg.chat_id_, msg.id_, 1, '☑️ ● تم تفعيل (طرد + حظر) الاعضاء ✓', 1, 'md')
end
...
if (text and (text == "قفل الوسائط") and (is_creator(msg) or is_creatorbasic(msg))) then
database:set("Tshake:lock:all"..bot_id..msg.chat_id_,"tshake")
database:set("lock_media:tshake"..msg.chat_id_..bot_id,"ok")
database:set("lock_audeo:tshake"..msg.chat_id_..bot_id,"ok")
database:set("lock_video:tshake"..msg.chat_id_..bot_id,"ok")
database:set("lock_photo:tshake"..msg.chat_id_..bot_id,"ok")
...
tsX000("lock",msg,"☑️ | اهلا عزيزي تم قفل الكل")
database:set("lock_contact:tshake"..msg.chat_id_..bot_id,"ok")
database:set("lock_pin:tshake"..msg.chat_id_..bot_id,"ok")
database:set("lock_fwd:tshake"..msg.chat_id_..bot_id,"ok")
database:set("lock_inline:tshake"..msg.chat_id_..bot_id,"ok")
...
if (text and (text == "فتح الوسائط")  and (is_creator(msg) or is_creatorbasic(msg))) then
database:del("Tshake:lock:all"..bot_id..msg.chat_id_)
send(msg.chat_id_, msg.id_, 1, '☑️ ● تم فتح الوسائط ✓', 1, 'md')
end
...
text = '☑️ ● تم طرد الحسابات المتروكه ✓'
send(msg.chat_id_, msg.id_, 1, text, 1, 'md')
end
...
local function cb(extra,result,success)
local list = result.members_
moody = '☑️ ● تم رفع ادمنيه المجموعه ✓\n'
local n = 0
for k,v in pairs(list) do
n = (n + 1)
local hash =  'tshake:'..bot_id..'mods:'..msg.chat_id_
...
tsX000("lock",msg,"☑️ ● تم قفل تعديل المجموعه ✓")
else
tsX000("lock",msg,"☑️ ● تم قفل تعديل المجموعه بالفعل✓")
end
end
...
send(msg.chat_id_, msg.id_, 1, '☑️ ● امر اطردني بالفعل تم تفعيله ✓', 1, 'md')
else
send(msg.chat_id_, msg.id_, 1, '☑️ ● امر اطردني تم تفعيله ✓', 1, 'md')
...
send(msg.chat_id_, msg.id_, 1, '📛 ● امر اطردني تم تعطيله ✓', 1, 'md')
...
send(msg.chat_id_, msg.id_, 1, '⛔️ ● ارسل : نعم ليتم طردك ✓\n⚪️ ● ارسل : لا. لالغاء الامر ✓', 1, 'md')
else
...
send(msg.chat_id_, msg.id_, 1, '☑️ ● لقد تم طردك   ✓', 1, 'md')
end
end
end
...
--------------------------------------
if text:match("^[Dd][Ee][Vv]$")or text:match("^مطور بوت$") or text:match("^مطورين$") or text:match("^مطور البوت$") or text:match("^مطور$") or text:match("^السورس$") or text:match("^المطور$") and msg.reply_to_message_id_ == 0 then
...
function promote_by_reply(extra, result, success)
if redis:sismember('tshake:'..bot_id..'dev', result.sender_user_id_) then
tsX000("prore",msg,'☑️ ●  بالفعل تم رفعة مطور في البوت  ✓ ')
else
redis:set('tshake:'..bot_id..'sudoo'..result.sender_user_id_..'', 'yes')
redis:sadd('tshake:'..bot_id..'dev', result.sender_user_id_)
tsX000("prore",msg,'☑️ ●  تم رفعة مطور في البوت  ✓ ')
end
end
getMessage(msg.chat_id_, msg.reply_to_message_id_,promote_by_reply)
end
...
send(msg.chat_id_, msg.id_, 1, "☑️ ● تم مسح قائمة المطورين  ✓", 1, 'md')
end
...
send(msg.chat_id_, msg.id_, 1, "☑️ | تم وضع القوانين للمجموعه", 1, 'md')
end
...
send(msg.chat_id_, msg.id_, 1, "🔖 ⁞ تم وضع وصف للمجموعة ✓", 1, 'md')
end
end
end
...
----------------------------------------------------------------------------------------------
if text:match('^مسح (%d+)$') and (is_owner(msg) or is_creatorbasic(msg)) then
...
pm ='🗑 ● تم مسح <b>{'..matches[2]..'}</b> من الرسائل'
send(msg.chat_id_, msg.id_, 1, pm, 1, 'html')
end
else pm ='❕┇هناك خطأ'
send(msg.chat_id_, msg.id_, 1, pm, 1, 'html')
...
----------------------------------------------------------------------------------------------
if (text and text == 'تفعيل الايدي بالصوره') and (is_creator(msg) or is_creatorbasic(msg)) then
if not database:get('tshake:'..bot_id..'id:photo'..msg.chat_id_) then
send(msg.chat_id_, msg.id_, 1, '🌁 ● بالفعل الايدي بالصوره مفعل ✓', 1, 'md')
else
send(msg.chat_id_, msg.id_, 1, '🌁 ● تم تفعيل الايدي بالصوره ✓', 1, 'md')
database:del('tshake:'..bot_id..'id:photo'..msg.chat_id_)
end
end
if (text and text == 'تعطيل الايدي بالصوره') and (is_creator(msg) or is_creatorbasic(msg)) then
if database:get('tshake:'..bot_id..'id:photo'..msg.chat_id_) then
send(msg.chat_id_, msg.id_, 1, '🌁 ● بالفعل الايدي بالصوره معطل✓', 1, 'md')
else
...
info = '👤¦ العضو ['..result2.first_name_..'](t.me/'..(result2.username_ or 'TTYYii')..')\n☑┇تم رفعه '..a[1]
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
...
send(msg.chat_id_, msg.id_, 1, '🆔 ● الايدي تم تعطيله ✓', 1, 'md')
...
● ⁞ قفل «» فتح ◄ الكل بالثواني + العدد
● ⁞ قفل «» فتح ◄ الكل بالساعه + العدد  
────────────────── 
★ Ch【@scsoo】☜ للاستفسار
]]
...
📋 ردود المطور
 ¦ـ➖➖➖➖➖➖➖
🔘 تغيير امر المطور
🔘 تغيير/مسح امر المطور بالكليشه
🔘 تعيين/مسح مجموعه المطور
